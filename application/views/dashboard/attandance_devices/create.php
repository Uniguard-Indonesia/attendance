            ...
            <div class="col-xl-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body">
                        <?php echo form_open_multipart('attandance_devices/store'); ?>
                        <div class="img-preview d-flex">
                            <img src="<?= 'https://smartschoolintegrated.com/assets/img/default_device.jfif' ?>" id="gmbr" class="img-fluid img-thumbnail mx-auto d-block text-center" style="height:200px" alt="">
                        </div>
                        <?= $this->session->flashdata('message'); ?>
                        <fieldset>
