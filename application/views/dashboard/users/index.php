                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-heading">
                        ...
                        <div class="panel-heading-btn">
                            ...
                            <a href="<?= base_url('/users/create') ?>" class="btn btn-primary float-right fas fa-plus"></a>
                        </div>
                    </div>
                            ...
                            <tbody>
                                ...
                                foreach ($users as $user) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="fa btn-sm fa-edit btn bg-warning text-white" href="<?= base_url('/users/edit/' . $user['id_user']) ?>"></a>
